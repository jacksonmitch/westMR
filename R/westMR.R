...
#'  \code{formula} \tab The model formula (coerced to
#'  \code{cbind(success, failure)} form for binomial responses). \cr
#'  \code{family} \tab The response family used, one of
#'  \code{"gaussian"}, \code{"poisson"}, or \code{"binomial"}. \cr
...
#'  \code{best_fit} \tab The fit (an object of class \code{fit_fmr})
#'  at the BIC-optimal number of components for the final model. \cr
...
#'  the step-by-step search log. \cr
